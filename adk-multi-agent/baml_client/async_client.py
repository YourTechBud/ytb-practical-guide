...
class BamlAsyncClient:
    ...
    async def ProjectManagerNextAction(
        self,
        context: str,
        baml_options: _baml.BamlCallOptions = {},
...
class BamlStreamClient:
    ...
    def ProjectManagerNextAction(
        ...
        context: str,
        baml_options: _baml.BamlCallOptions = {},
    ) -> baml_py.BamlStream[Optional[Union[_baml.partial_types.ProjectManagerActionToolCall, _baml.partial_types.AgentActionEnd, _baml.partial_types.AgentActionInputRequired]], Union[_baml.types.ProjectManagerActionToolCall, _baml.types.AgentActionEnd, _baml.types.AgentActionInputRequired]]:
      options: _baml.BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlStream[Optional[Union[_baml.partial_types.ProjectManagerActionToolCall, _baml.partial_types.AgentActionEnd, _baml.partial_types.AgentActionInputRequired]], Union[_baml.types.ProjectManagerActionToolCall, _baml.types.AgentActionEnd, _baml.types.AgentActionInputRequired]](
        raw,
