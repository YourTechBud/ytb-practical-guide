...
from utils.model import GraphDeps
...
@task_manager_agent.tool
def read_tasks(ctx: RunContext[GraphDeps]) -> str:
    """
    Reads all tasks
    """
...
@task_manager_agent.tool
def add_task(ctx: RunContext[GraphDeps], title: str) -> str:
    """
...
@task_manager_agent.tool
def mark_task_as_done(ctx: RunContext[GraphDeps], title: str) -> str:
    """
